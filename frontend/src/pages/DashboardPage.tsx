...
import {
    ...
    Button, FormControl, InputLabel, CircularProgress
} from '@mui/material';
            ...
            <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, gap: 4 }}>
                <Box sx={{ width: { xs: '100%', md: '41.666%' } }}>
                    <Box sx={{ p: 3, bgcolor: 'white', borderRadius: 2, boxShadow: 1 }}>
                        ...
                        <TextField label="Message" multiline rows={6} fullWidth value={message} onChange={(e) => setMessage(e.target.value)} sx={{ mb: 2 }} />
                        <TextField
                            type="datetime-local"
